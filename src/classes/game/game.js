...
class Game {
    ...
    initializeTiles() {
        const tilesGenerator = new TilesGenerator(this.ctx, placementTilesData, PlacementTile);
    ...
    handleProjectileCollision(projectile, building, i) {
        const distance = this.calculateDistance(projectile.enemy.center, projectile.position);
